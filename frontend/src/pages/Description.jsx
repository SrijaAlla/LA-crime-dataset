      ...
      <div className="table-container">
        ...
        <table class="styled-table">
          ...
          <tbody>
            <tr>
              <td>DR_NO</td>
              <td>Division of Records Number: Official file number
                made up of a 2-digit year, area ID, and 5-digit</td>
            </tr>
            <tr>
              <td>Date Rptd</td>
              <td>This column likely represents the date when the
                crime was reported to authorities in the format MM/DD/YYYY</td>
            </tr>
            <tr>
              <td>DATE OCC</td>
              <td>This column likely represents the date when the
                crime actually occurred in the format MM/DD/YYYY.</td>
            </tr>
            <tr>
              <td>TIME OCC</td>
              <td> This column represents the time at which the
                crime occurred in military time.</td>
            </tr>
            <tr>
              <td>AREA NAME</td>
              <td>The 21 Geographic Areas or Patrol Divisions are
            ...
            <tr>
              <td>Rpt Dist No</td>
              <td>This column contains a report district number
            ...
            <tr>
              <td>Crm Cd</td>
              <td>This column contains a numerical code indicating
                the crime committed.</td>
            </tr>
            <tr>
              <td>Crm Cd 2</td>
              <td>May contain a code for an additional crime, less
                serious than Crime Code 1.</td>
            </tr>
            <tr>
              <td>Crm Cd desc</td>
              <td>This column provides a textual description of
                the crime.</td>
            </tr>
            <tr>
              <td>Mocodes</td>
              <td>This column may contain additional codes or Modus
            ...
            <tr>
              <td>Vict Descent</td>
              <td>This column indicates the race or ethnicity
                of the victim.</td>
            </tr>
            <tr>
              <td>Premis cd</td>
              <td>This column contains a code representing the
                type of location where the crime occurred.</td>
            </tr>
            <tr>
              <td>Premis Desc</td>
              <td>This column provides a textual description of
                the location where the crime occurred</td>
            </tr>
            <tr>
              <td>Weapon Used Cd</td>
              <td>This column contains a code representing
                the type of weapon used in the crime.</td>
            </tr>
            <tr>
              <td>Weapon Desc</td>
              <td>This column provides a textual description of
            ...
            <tr>
              <td>Status</td>
              <td>This column may indicate the status of the crime
                report</td>
            </tr>
            <tr>
              <td>Status Desc</td>
            ...
            <tr>
              <td>LOCATION</td>
              <td>The street address of the crime incident was
                rounded to the nearest hundred block to maintain anonymity.</td>
            </tr>
            <tr>
              <td>LAT</td>
              <td>This column provides the latitude coordinates of the
                crime location.</td>
            </tr>
            <tr>
              <td>LON</td>
              <td>This column provides the longitude coordinates of the
                crime location.</td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="styled-table">
          ...
          <tbody>
            <tr>
              <td>Weapons</td>
              <td>This column provides descriptions of various
                weapons. An accompanying column 'weapon rating' assigns a
                severity rating from 1 to 10 for each weapon based on its
                perceived danger level.</td>
            </tr>
            <tr>
              <td>Crimes</td>
              <td>This column gives the crime rating of a district
                based on the number of crimes where the intesity of the crime is
                rated on a scale of 1-10 manually.</td>
            </tr>
            <tr>
              <td>Year</td>
              <td>This column indicates the year when the crime
                occurred.</td>
            </tr>
            <tr>
              <td>Month</td>
              <td>This column indicates the month when the crime
                occurred.</td>
            </tr>
            <tr>
              <td>crime_type</td>
              <td>This column specifies the type of crime which
                is divided into violent</td>
            </tr>
            <tr>
              <td>Vehicular</td>
              <td>A crime is categorised as vehicular if the the
                crime involves a vehicle</td>
            </tr>
            <tr>
              <td>Theft</td>
              <td>A crime is categorised as theft if the the crime
                involves a robbery.</td>
            </tr>
          </tbody>
        </table>
